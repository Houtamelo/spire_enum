    ...
    let enum_own_def = {
        let docs = docs_tokens(format!(
            "{DOCS_INTRO}\n\n\
			 ...
			 This enum is used when converting the type [`{table_ident}`] into an iterator."
        ));
    ...
    let table_impls = {
        ...
        quote! {
            ...
            impl #gen_params #table_ty {
                ...
                #[doc = "Replaces the field associated with the variant type `Var`, with the contents of `value`.\n\n\
                ...
                pub fn set<Var: #key_trait_ty>(&mut self, value: #gen_t) {
